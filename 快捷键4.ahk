...
;复制文件路径 ctrl+shift+c
; [moved] queue copy lives in clipboard_v1.ahk —disabled here to avoid fighting ^+c
;~^+c::{
...
;ctrl+shift+v dbeaver / goland —moved to clipboard_v1.ahk (queue FIFO + legacy transform)
